...
import com.android.nfRequest.ParseError;
...
public class ImageRequest extends Request<Bitmap> {
    ...
    public ImageRequest(String url, Response.Listener<Bitmap> listener, int maxWidth, int maxHeight,
        ...
        setRetryPolicy(new com.android.nfRequest.DefaultRetryPolicy(DEFAULT_IMAGE_TIMEOUT_MS, DEFAULT_IMAGE_MAX_RETRIES,
    ...
    protected Response<Bitmap> parseNetworkResponse(NetworkResponse response) {
        ...
        synchronized (sDecodeLock) {
            try {
                ...
                NFLog.e("Caught OOM for %d byte image, url=%s", response.data.length, getUrl());
