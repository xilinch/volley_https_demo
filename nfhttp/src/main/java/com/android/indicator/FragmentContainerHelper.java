...
public class FragmentContainerHelper {
    private List<NFCustomIndicator> mNFCustomIndicators = new ArrayList<NFCustomIndicator>();
    ...
    public FragmentContainerHelper(NFCustomIndicator NFCustomIndicator) {
        mNFCustomIndicators.add(NFCustomIndicator);
    }
    ...
    public void attachMagicIndicator(NFCustomIndicator NFCustomIndicator) {
        mNFCustomIndicators.add(NFCustomIndicator);
    }

    private void dispatchPageSelected(int pageIndex) {
        for (NFCustomIndicator NFCustomIndicator : mNFCustomIndicators) {
            NFCustomIndicator.onPageSelected(pageIndex);
        }
    }
